...
public class NavigationDrawerAdapter extends RecyclerView.Adapter<NavigationDrawerAdapter.ViewHolder> {
    ...
    public NavigationDrawerAdapter(String Titles[], int Icons[], String Name, String Email, int Profile) { // NavigationDrawerAdapter Constructor with titles and icons parameter
